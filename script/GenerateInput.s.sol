...
/// @author VulcanROI
/// @notice This contract generates a JSON input file for a Merkle tree airdrop
contract GenerateInput is Script {
    ...
    /// @notice Runs the script to generate the input JSON file
    function run() public {
        types[0] = "address";
        types[1] = "uint";
    ...
    /// @notice Creates a JSON string from the whitelist and amount
    /// @return The JSON string representing the whitelist and amounts
